...
func Test_getMacAddress(t *testing.T) {
	mac := getMacAddress("hello")
	assert.Equal(t, "52:54:00:07:b9:ab", mac)
}

//func TestMachine_MacAddress(t *testing.T) {
//	c := NewNomadClient(nil)
//
//	//ctx := context.Background()
//
//	ubuntu, _, err := c.Jobs().Info("ubuntu2", nil)
//	assert.Nil(t, err, "expecting nil error")
//	assert.NotEmpty(t, ubuntu)
//
...
//	c := NewClient(os.Getenv("NOMAD_ENDPOINT"), os.Getenv("NOMAD_API_KEY"))
//
//	ctx := context.Background()
//
